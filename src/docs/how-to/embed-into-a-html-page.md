...
1. include the `driver.min.js` script from your Metreeca/Self installation (
   e.g. <https://demo.metreeca.com/self/driver.min.js>) anywhere in your page;
2. embed one or more Metreeca/Self instances using `iframe` elements annotated with `data-*` attributes defining content
   and layout.

```html

<script type="application/javascript"
		src="https://demo.metreeca.com/self/driver.min.js"></script>
```

```html

<iframe [name="<instance name>" ]
		src="https://demo.metreeca.com/self/"
		[data-
<content option>="
	<value>"]*
...
Basic, cut-and-paste ready samples are available at <https://demo.metreeca.com/self/samples/>.
