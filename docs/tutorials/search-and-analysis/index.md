...
Should you want to try out Metreeca/Self on your own datasets, make sure that your SPARQL endpoint fully [supports](../../handbooks/system#sparql-endpoint) CORS requests and review [data usability](../../how-tos/improve-user-experience#data-usability) guidelines.
